 ...
 */
 function clearAll() {
    const generatedNodeArr = document.querySelectorAll('.generated');
    generatedNodeArr.forEach(e => e.parentElement.removeChild(e));
 }
 ...
 function showMeme() {
   ...
   newMeme.setAttribute('class','generated');
   clearAll();
   document.querySelector('#memes').appendChild(newMeme);
 }
 ...
 function showJoke() {
   ...
   newJoke.setAttribute('class','generated');
   newJoke.textContent=randomJokeText;
   clearAll();
   document.querySelector('#funny').appendChild(newJoke);
 }
 ...
 function showQuote() {
   ...
   newQuote.setAttribute('class','generated');
   const str ='Quote: '+randomQuote.quote+"\n -- "+randomQuote.author;
   newQuote.textContent=str;
   clearAll();
   document.querySelector('#wisdom').appendChild(newQuote);
 }
 ...
 function showRiddle() {
   ...
   newRiddle.setAttribute('class','generated');
   newRiddle.setAttribute('id','question');
   const str ='Question: '+randomRiddle.question;
   newRiddle.textContent=str;
   const ans = document.createElement('p');
    ans.setAttribute('class','generated');
    ans.setAttribute('id','answer');
    ans.textContent='Answer: '+randomRiddle.answer;
    ans.hidden=true;
   clearAll();
   document.querySelector('#riddle').appendChild(newRiddle);
 ...
 function revealAnswers() {
    const quesPresent = document.querySelector('#question');
    const ansPresent = document.querySelector('#answer');
    if(quesPresent==null) alert('There is no riddle present');
    else if(ansPresent.hidden==false) alert('The answer is already revealed');
    else{
        ansPresent.hidden=false;        
    }
 }
